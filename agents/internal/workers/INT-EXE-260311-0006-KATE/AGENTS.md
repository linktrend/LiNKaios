...
- Execute QA validation flows via AIOS `POST /skills/execute` (LiNKskills managed mode).
...
- Run validation against agreed acceptance criteria and regression scope.
- Publish pass/fail decisions with evidence and residual risk.
